                    ...
                    <div id="nav_menu-3" class="widget w-sidebar rb-section clearfix widget_nav_menu">
                        <div class="block-h widget-heading heading-layout-10">
                            <div class="heading-inner">
                                ...
                                <a style="margin-left: 10px;" href="mailto:{{$row->email}}" target="_blank">{{$row->email}}</a>
                            </div>
                            <div class="heading-inner">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                ...
                                <a style="margin-left: 10px;" href="https://instagram.com/{{$row->ig}}" target="_blank">{{$row->ig}}</a>
                            </div>
                            <div class="heading-inner">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                ...
                                <a style="margin-left: 10px;" href="https://wa.me/+62{{$row->wa}}" target="_blank">{{$row->wa}}</a>
                            </div>
