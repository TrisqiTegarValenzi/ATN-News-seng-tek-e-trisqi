            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" >
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Deskripsi Penghargaan </h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    @endif
                            ...
                            @endif
                            <div class="card-box">
                                <form action="/insert_deskripsi" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="my-3 p-3 bg-body rounded shadow-sm">
                                        ...
                                        <!-- <input type="checkbox" name="privasi" id="privasi" value="{{old('option')}}"><label for="option"> <p> Setuju <a href="{{url('deskripsi')}}">Kebijakan & Privasi</a></p></label> -->
                                        <!-- <a href="{{url('deskripsi')}}"><span>Privasi</span></a> -->
